    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('users/store') ?>" method="POST" enctype="multipart/form-data" id="formUser">
                        <?= csrf_field() ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select <?= isset($errors['level']) ? 'is-invalid' : '' ?>"
                                    ...
                                    <option value="2" <?= old('level') == '2' ? 'selected' : '' ?>>Customer Service</option>
                                    <option value="3" <?= old('level') == '3' ? 'selected' : '' ?>>Publikasi</option>
                                </select>
